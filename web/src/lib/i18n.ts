...
export const translations = {
  ko: {
    // Site meta
    siteTitle: "Claude Code 이야기 — 스토리텔링으로 배우는 Harness Engineering",
  ...
  en: {
    // Site meta
    siteTitle: "Jimin's 4 Weeks — Learning Harness Engineering through Storytelling",
    siteDescription: "Follow Jimin's 4-week journey to master Claude Code and become a Harness Engineer",

    // Layout
    skipToContent: "Skip to content",
    headerTitle: "Jimin's 4 Weeks",
