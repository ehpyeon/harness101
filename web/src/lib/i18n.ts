...
export const translations = {
  ko: {
    ...
    heroDesc4: "가 되기까지.",
    heroProblemBody: "CLAUDE.md, Skills, MCP, Rules, SubAgents… 처음엔 용어부터 낯섭니다. 왜 이게 필요한지, 어떻게 연결되는지 잘 모르겠다면 — 정상입니다.",
    heroInsight: "이 모든 개념은 하나로 연결됩니다. 에이전트를 잘 활용하려면 모델 자체보다 그 에이전트가 일하는 환경(Harness)이 중요합니다. 그 환경을 이해하고 설계하는 것 — 그것이 Harness Engineering입니다.",
    heroLayerTools: "Claude가 사용할 수 있는 외부 도구와 실행 능력",
    heroLayerKnowledge: "Claude가 참조하는 사전 지식 — 규칙, 스킬, 기억",
    heroLayerContext: "작업 범위, 우선순위, 대화 상태 관리",
    heroLayerPermissions: "Claude의 행동 경계와 보안 정책 설정",
    heroClosing: "Harness의 탄생 배경과 각 요소의 역할을 이해하면서, 자연스럽게 Claude Code에 대한 이해를 높입니다.",
  ...
  en: {
    ...
    heroDesc3: "Harness Engineer",
    heroDesc4: ".",
    heroProblemBody: "CLAUDE.md, Skills, MCP, Rules, SubAgents… the terminology alone can feel overwhelming. Why does each thing exist, and how do they connect? If that sounds familiar, you're not alone.",
    heroInsight: "Every concept connects through one idea. To get the most from an agent, what matters isn't the model — it's the environment where that agent works (the Harness). Understanding and shaping that environment is Harness Engineering.",
    heroLayerTools: "External tools and execution capabilities Claude can use",
    heroLayerKnowledge: "Pre-loaded knowledge — rules, skills, and memory Claude draws on",
    heroLayerContext: "Task scope, priority, and conversation state management",
    heroLayerPermissions: "Boundaries and security policies that govern Claude's behavior",
    heroClosing: "By understanding where Harness comes from and what each layer does, you'll naturally build a deeper understanding of Claude Code.",
