...
export const translations = {
  ko: {
    ...
    heroDesc4: "가 되기까지.",
    heroProblemQ: "Claude Code, 제대로 쓰고 싶으신가요?",
    heroProblemBody: "CLAUDE.md, Skills, MCP, Rules, SubAgents… 처음엔 용어부터 낯섭니다. 각각이 뭔지는 알겠는데, 왜 이게 필요한지, 어떻게 연결되는지 잘 모르겠다면 — 정상입니다.",
    heroInsight1: "이 모든 개념은 하나의 질문으로 연결됩니다.",
    heroInsight2: "에이전트를 잘 활용하려면, 모델 자체보다 그 에이전트가 일하는 환경이 중요합니다.",
    heroInsight3: "그 환경을 이해하고 설계하는 것 — 그것이 Harness Engineering입니다.",
    heroOutcome: "Skills, SubAgents, MCP, Rules의 역할을 이해하고 나면, Claude Code를 이전과는 전혀 다른 수준으로 쓰게 됩니다.",
  ...
  en: {
    ...
    heroDesc3: "Harness Engineer",
    heroDesc4: ".",
    heroProblemQ: "Want to get more out of Claude Code?",
    heroProblemBody: "CLAUDE.md, Skills, MCP, Rules, SubAgents… the terminology alone can feel overwhelming. You kind of know what each thing is — but why does it exist, and how does it all fit together? If that sounds familiar, you're not alone.",
    heroInsight1: "Every one of these concepts connects through a single question.",
    heroInsight2: "To get the most from an agent, what matters isn't the model itself — it's the environment where that agent works.",
    heroInsight3: "Understanding and shaping that environment is Harness Engineering.",
    heroOutcome: "Once you understand the role of Skills, SubAgents, MCP, and Rules, you'll use Claude Code at a completely different level.",
